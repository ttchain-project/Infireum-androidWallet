...
import com.ttchain.walletproject.blockchain.ChineseSimplified;
...
//            WORD_LIST = Collections.unmodifiableList(populateWordList());
    ...
    private static List<String> chineseSimplifiedWordList() {
        return ChineseSimplified.INSTANCE.getWordList();
    }
