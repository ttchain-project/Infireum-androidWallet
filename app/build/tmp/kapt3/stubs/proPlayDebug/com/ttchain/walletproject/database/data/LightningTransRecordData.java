...
public final class LightningTransRecordData {
    ...
    public LightningTransRecordData(int _id) {
        super();
    }
    
    public LightningTransRecordData() {
        super();
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.ttchain.walletproject.database.data.LightningTransRecordData copy(int _id) {
        return null;
    }
