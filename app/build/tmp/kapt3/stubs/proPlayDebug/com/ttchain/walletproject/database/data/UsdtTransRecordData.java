...
public final class UsdtTransRecordData {
    ...
    public UsdtTransRecordData(int _id) {
        super();
    }
    
    public UsdtTransRecordData() {
        super();
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.ttchain.walletproject.database.data.UsdtTransRecordData copy(int _id) {
        return null;
    }
